...
/*   Updated: 2025/04/19 15:46:12 by oishchen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	printf("we got the pid correctly: %d\n", srv_pid);
	while (argv[2][i])
	{
	...
	while (!end)
		pause();
	printf("The whole message was received, terminating the program\n");
	return (0);
}